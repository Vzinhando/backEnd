        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    descricaoAvaliacao = table.Column<string>(type: "TEXT", unicode: false, maxLength: 500, nullable: true),
                    estrelasAvaliacao = table.Column<decimal>(type: "decimal(3, 1)", nullable: false),
                    dataAvaliacao = table.Column<DateOnly>(type: "TEXT", nullable: true, defaultValueSql: "(getdate())")
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    idCupom = table.Column<int>(type: "INTEGER", nullable: false)
                        .Annotation("Sqlite:Autoincrement", true),
                    codigoCupom = table.Column<string>(type: "TEXT", unicode: false, maxLength: 50, nullable: false),
                    tipoCupom = table.Column<string>(type: "TEXT", unicode: false, maxLength: 50, nullable: true),
                    porcentagemDescontoCupom = table.Column<decimal>(type: "decimal(5, 2)", nullable: true),
                    statusCupom = table.Column<string>(type: "TEXT", unicode: false, maxLength: 30, nullable: false),
                    dataValidadeCupom = table.Column<DateOnly>(type: "TEXT", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    idPlano = table.Column<int>(type: "INTEGER", nullable: false)
                        .Annotation("Sqlite:Autoincrement", true),
                    tipoPlano = table.Column<string>(type: "TEXT", unicode: false, maxLength: 50, nullable: false),
                    valorPlano = table.Column<decimal>(type: "decimal(10, 2)", nullable: false),
                    statusPlano = table.Column<string>(type: "TEXT", unicode: false, maxLength: 30, nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    idUsuario = table.Column<int>(type: "INTEGER", nullable: false)
                        .Annotation("Sqlite:Autoincrement", true),
                    nomeUsuario = table.Column<string>(type: "TEXT", unicode: false, maxLength: 150, nullable: false),
                    emailUsuario = table.Column<string>(type: "TEXT", unicode: false, maxLength: 255, nullable: false),
                    senhaUsuario = table.Column<string>(type: "TEXT", unicode: false, maxLength: 255, nullable: false),
                    tipoUsuario = table.Column<string>(type: "TEXT", unicode: false, maxLength: 30, nullable: false),
                    dataCadastroUsuario = table.Column<DateOnly>(type: "TEXT", nullable: true, defaultValueSql: "(getdate())"),
                    dataNascimentoUsuario = table.Column<DateOnly>(type: "TEXT", nullable: true),
                    sexoUsuario = table.Column<string>(type: "TEXT", unicode: false, fixedLength: true, maxLength: 1, nullable: true),
                    cepUsuario = table.Column<string>(type: "TEXT", unicode: false, fixedLength: true, maxLength: 9, nullable: true),
                    enderecoUsuario = table.Column<string>(type: "TEXT", unicode: false, maxLength: 255, nullable: true),
                    cidadeUsuario = table.Column<string>(type: "TEXT", unicode: false, maxLength: 100, nullable: true),
                    telefoneUsuario = table.Column<string>(type: "TEXT", unicode: false, maxLength: 20, nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    idUsuario = table.Column<int>(type: "INTEGER", nullable: false),
                    idPlano = table.Column<int>(type: "INTEGER", nullable: false),
                    dataAssinatura = table.Column<DateOnly>(type: "TEXT", nullable: false, defaultValueSql: "(getdate())"),
                    dataExpiracao = table.Column<DateOnly>(type: "TEXT", nullable: true),
                    statusAssinatura = table.Column<string>(type: "TEXT", unicode: false, maxLength: 30, nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    idPerfil = table.Column<int>(type: "INTEGER", nullable: false)
                        .Annotation("Sqlite:Autoincrement", true),
                    idUsuario = table.Column<int>(type: "INTEGER", nullable: false),
                    nomePerfil = table.Column<string>(type: "TEXT", unicode: false, maxLength: 100, nullable: false),
                    categoriaPerfil = table.Column<string>(type: "TEXT", unicode: false, maxLength: 50, nullable: true),
                    descricaoPerfil = table.Column<string>(type: "TEXT", unicode: false, maxLength: 500, nullable: true),
                    fotoPerfilUrl = table.Column<string>(type: "TEXT", unicode: false, nullable: true),
                    redeSocialPerfil = table.Column<string>(type: "TEXT", unicode: false, maxLength: 255, nullable: true),
                    tipoLocalUsuario = table.Column<string>(type: "TEXT", unicode: false, maxLength: 50, nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    dataContratacao = table.Column<DateOnly>(type: "TEXT", nullable: false, defaultValueSql: "(getdate())"),
                    valorCombinado = table.Column<decimal>(type: "decimal(10, 2)", nullable: true),
                    statusContratacao = table.Column<string>(type: "TEXT", unicode: false, maxLength: 30, nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    idServicoOferecido = table.Column<int>(type: "INTEGER", nullable: false)
                        .Annotation("Sqlite:Autoincrement", true),
                    idPerfil = table.Column<int>(type: "INTEGER", nullable: false),
                    nomeServico = table.Column<string>(type: "TEXT", unicode: false, maxLength: 100, nullable: false),
                    descricaoServico = table.Column<string>(type: "TEXT", unicode: false, maxLength: 500, nullable: true),
                    precoBase = table.Column<decimal>(type: "decimal(10, 2)", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    formaPagamento = table.Column<string>(type: "TEXT", unicode: false, maxLength: 50, nullable: true),
                    idTransacao = table.Column<string>(type: "TEXT", unicode: false, maxLength: 255, nullable: true),
                    statusPagamento = table.Column<string>(type: "TEXT", unicode: false, maxLength: 30, nullable: false),
